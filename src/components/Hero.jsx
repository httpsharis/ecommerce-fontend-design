                ...
                <div className="col-start-5 row-span-5 flex flex-col gap-4 p-4">
                    <div className="flex-1 bg-[#E3F0FF] rounded-lg p-4">
                        ...
                        <div className='flex flex-col gap-[6px]'>
                            <button className='w-full py-[6px] text-[13px] font-medium bg-[#0067FF] text-white rounded-lg 
                    border border-[#0052CC] shadow hover:bg-[#0052CC] active:translate-y-[1px] transition-all'>
                                Join now
                            </button>
                            <button className='w-full py-[6px] text-[13px] font-medium text-gray-600 bg-white rounded-lg
                    border border-gray-200 shadow hover:bg-gray-50 active:translate-y-[1px] transition-all'>
                                Log in
                            </button>
                        </div>
                    </div>
                    ...
                    {/* Discount section */}
                    <div className="bg-[#F38332] rounded-lg p-3">
                    ...
                    <div className="flex-1 bg-[#55BDC3] rounded-lg p-3">
                        <p className='text-[16px] text-white'>
